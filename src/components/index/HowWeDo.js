    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="grid gap-4 w-full max-w-[130rem]">
        ...
        <div className="flex flex-col mx-[10%]">
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🏆 High Scores</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🧑‍🤝‍🧑 Partnerships</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🎨 Fan Art Contests</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🕹️ Game Nights</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🌟 Launch Parties</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🌎 Global Events</div>
          ...
          <ShowOnHover>
            <div className="text-orange pr-2">🔮 Quantum Predictions</div>
