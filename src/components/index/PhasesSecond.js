export default function PhasesSecond() {
  return (
    <div className="relative min-h-screen flex justify-center items-center">
      <div className="grid gap-4 ml-[50%] mr-[10%]">
        <div className="grid gap-2">
          <h2 className="text-green">Phase 4 - Launch</h2>
          <h2>
            Eclectic Qbit will work closely with the project team to ensure a
            successful launch, including handling any techni - cal issues that
            may arise and managing the release of the NFTs. We will use planet
            and rocket emojis to signify the launch and success of the project.
            <br />
            Benefits: A smooth and successful launch that generates excitement
            and drives sales for the Web3 project. <br />
            Timeline: 1-2 weeks
          </h2>
        </div>
        <div className="grid gap-2">
          <h2 className="text-green">Phase 5 - Post-Launch</h2>
          <h2>
            Eclectic Qbit will continue to provide ongoing support for the
            project post-launch, monitoring sales, engagement, and community
